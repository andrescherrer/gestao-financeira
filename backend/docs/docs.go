    ...
    "paths": {
        ...
        "/api/v1/auth/register": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "User registered successfully\" \"Example: {\\\"message\\\": \\\"User registered successfully\\\", \\\"data\\\": {\\\"user_id\\\": \\\"uuid\\\", \\\"email\\\": \\\"user@example.com\\\", \\\"first_name\\\": \\\"John\\\", \\\"last_name\\\": \\\"Doe\\\", \\\"full_name\\\": \\\"John Doe\\\"}}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Bad request - Invalid input data (e.g., invalid email format, password too short, missing fields)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
